    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"> <a class="navbar-brand logo-div" href="dashboard.php"> <img class="brand-logo img-fluid"
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item d-flex align-items-center"> 
                        <a class="dropdown-toggle nav-link dropdown-user-link"  data-toggle="dropdown"> 
                            ...
                            <span class="user-name mb-0">{{auth()->user()->firstname}}
...
<div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item <?php if ("dashboard") {echo "active"; } else  {echo "";}?>"><a href="dashboard.php"><i class="fas fa-home"></i><span class="menu-title" data-i18n="">Dashboard</span></a></li>
            <li class="nav-item <?php if ("trainings") {echo "active"; } else  {echo "";}?>"><a
                href="{{route('trainings.index')}}"><i class="fas fa-file-alt"></i><span class="menu-title"
                data-i18n="">Trainings</span></a></li>
            <li class="nav-item <?php if ("user") {echo "active"; } else  {echo "";}?>"><a href="user-registration.php"><i
                        class="fas fa-user-circle"></i><span class="menu-title" data-i18n="">User Registration</span></a></li>
            <li class="nav-item <?php if ("payments") {echo "active"; } else  {echo "";}?>"><a href="payment-log.php"><i
                        class="fas fa-credit-card"></i><span class="menu-title" data-i18n="">Payment Log</span></a></li>
            <li class="nav-item <?php if ("feedback") {echo "active"; } else  {echo "";}?>"><a href="feedback.php" class="d-flex"><i class="custom-icon"><svg width="18.173" height="18.173" viewBox="0 0 18.173 18.173">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content site-modal">
            ...
            <div class="text-center">
                ...
                <button type="submit" class="login-btn px-3" href="{{route('logout')}}">Yes</button>
                @csrf
                </form>
