                        ...
                        <div class="card">
                            <div class="card-content collapse show">
                                <div class="card-dashboard">
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="user-registration.php"><h2 class="mb-2"><i class="fas fa-angle-left"></i> User Registration Details</h2></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-2 pb-3 text-center text-sm-left">
                                            <a href="training-logs.php" class="site-btn px-5">Training Logs</a>
                                        </div>
                                    </div>
